...
int main(int argc, char **argv)
{
  ...
  {
    cerr << endl
         << "Usage: ./stereo_kitti path_to_vocabulary path_to_settings path_to_sequence (path_to_masks)" << endl;
    return 1;
  }
  ...
  if (argc == 5)
  {
    ...
    segParams.mask_rcnn_model_pb_path = "/home/lxy/Workspace/mrslam/catkin_ws/src/dynaslam_catkin/dynaslam/src/"
                                        "mask_rcnn.pb";
