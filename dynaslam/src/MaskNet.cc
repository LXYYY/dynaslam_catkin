...
cv::Mat SegmentDynObject::GetSegmentation(cv::Mat &image, std::string dir, std::string name)
{
  ...
  if (seg.empty())
  {
    ...
    PyObject *py_mask_image = PyObject_CallMethod(this->net, const_cast<char*>(this->get_dyn_seg.c_str()), "(O)",
                                                  py_image);
...
void SegmentDynObject::ImportSettings()
{
  std::string strSettingsFile =
      "/home/lxy/Workspace/mrslam/catkin_ws/src/dynaslam_catkin/dynaslam/Examples/RGB-D/MaskSettings.yaml";
